...
def main():
    ...
    registration_handler = RegistrationHandler(device_registry)
    c2dm_facade = C2DMServiceFacade()
    wakeup_handler = MDSWakeupHandler(c2dm_facade, device_registry)
    ...
    o = options.options
    application = WakeupMDSApplications(registration_handler, wakeup_handler)
